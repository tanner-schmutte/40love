...
Revision ID: b99b07d40df1
Revises: 
Create Date: 2021-03-07 10:46:25.948115
...
def upgrade():
    ...
    sa.Column('reviewee', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['hit_id'], ['hits.id'], ),
    sa.ForeignKeyConstraint(['reviewee'], ['players.id'], ),
    sa.ForeignKeyConstraint(['reviewer'], ['players.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
